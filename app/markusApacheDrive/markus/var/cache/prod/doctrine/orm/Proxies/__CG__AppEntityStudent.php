...
class Student extends \App\Entity\Student implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Student' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Student' . "\0" . 'Name', '' . "\0" . 'App\\Entity\\Student' . "\0" . 'Surname', '' . "\0" . 'App\\Entity\\Student' . "\0" . 'Telephone', '' . "\0" . 'App\\Entity\\Student' . "\0" . 'Email', '' . "\0" . 'App\\Entity\\Student' . "\0" . 'NumberIdentGoverment', '' . "\0" . 'App\\Entity\\Student' . "\0" . 'fk_id_user', '' . "\0" . 'App\\Entity\\Student' . "\0" . 'class'];
        }
     ...
     * {@inheritDoc}
     */
    public function setTelephone(?string $Telephone): \App\Entity\Student
    {
    ...
    public function getNumberIdentGoverment(): ?string
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getNumberIdentGoverment', []);

        return parent::getNumberIdentGoverment();
    }

    /**
     * {@inheritDoc}
     */
    public function setNumberIdentGoverment(?string $NumberIdentGoverment): \App\Entity\Student
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setNumberIdentGoverment', [$NumberIdentGoverment]);

        return parent::setNumberIdentGoverment($NumberIdentGoverment);
    }
     ...
     * {@inheritDoc}
     */
    public function setFkIdUser(\App\Entity\User $fk_id_user): \App\Entity\Student
    {
     ...
     * {@inheritDoc}
     */
    public function setClass(?\App\Entity\SchoolClass $class): \App\Entity\Student
    {
